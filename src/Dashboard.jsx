...
import PublicationYearTimeline from '../Components/PublicationYearTimeline';
import PriceRangeDistribution from '../Components/PriceRangeDistribution';
    ...
    <>
      ...
      <div className='main-content'>
        ...
        <div className="data-visualizations">
          <PublicationYearTimeline books={bookData.items} />
          <PriceRangeDistribution books={bookData.items} />
        </div>
